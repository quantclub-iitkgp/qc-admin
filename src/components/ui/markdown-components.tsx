...
/**
 * react-markdown component overrides — mirrors the public frontend renderer so
 * the admin preview matches. A link to a YouTube video renders as an embedded
 * responsive 16:9 player; every other link opens in a new tab.
 */
